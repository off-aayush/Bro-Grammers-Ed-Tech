...
export default function CoursesItem (props) {
  return (
    <div className=" cursor-pointer border-2 border-gray-300 dark:border-neutral-600 rounded-3xl hover:shadow-xl hover:shadow-gray-400">
        <a href={props.CourseUrl} target='_blank' rel="noreferrer">
            <img src={props.ImageUrl} className="h-full w-full rounded-t-3xl " alt="Course"/>
